...
import { PlatformUser, UsersPagination } from "./users-types";
...
const COLUMN_LABEL: Record<string, "name" | "role" | "status" | "joined"> = {
  name: "name",
  role: "role",
  status: "status",
  joined: "joined",
...
export function UsersDataTable({
  ...
  const columns = useUsersColumns({ onOpenBan, onActivate, onOpenDelete });
  ...
  const canResetFilters =
    Boolean(q.trim()) || roleFilter !== "ALL" || statusFilter !== "ALL";
