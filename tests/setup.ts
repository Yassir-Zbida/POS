...
vi.mock("@/lib/prisma", () => ({
  prisma: {
    ...
    productVariant: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn() },
    ...
    attribute: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), count: vi.fn() },
    attributeValue: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn() },
    productAttribute: { deleteMany: vi.fn(), create: vi.fn() },
    variantAttribute: { deleteMany: vi.fn(), create: vi.fn() },
    location: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), count: vi.fn() },
    user: { findUnique: vi.fn(), findMany: vi.fn(), findFirst: vi.fn(), create: vi.fn(), update: vi.fn() },
    subscription: { findUnique: vi.fn(), create: vi.fn() },
    refreshToken: { create: vi.fn() },
    auditLog: { create: vi.fn(), findFirst: vi.fn(), findMany: vi.fn(), count: vi.fn() },
    otpChallenge: { create: vi.fn(), findFirst: vi.fn(), update: vi.fn(), deleteMany: vi.fn(), delete: vi.fn() },
    $transaction: vi.fn(),
    $queryRaw: vi.fn(),
  },
}));
