...
const COPY: Record<Lang, { title: string; description: string; tryAgain: string; reference: string; langs: Record<Lang, string> }> = {
  fr: {
  ...
  ar: {
    title: "حدث خطأ",
    description: "حدث خطأ غير متوقع. يمكنك المحاولة مرة أخرى.",
